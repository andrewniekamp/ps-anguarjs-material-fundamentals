...
// This service is to simulate loading from a data store
module ContactManagerApp {
    ...
    // Service itself is using the above interface
    export class UserService implements IUserService {
        ...
        selectedUser: User = null; // User is null at outset?

        loadAllUsers() : ng.IPromise<User[]> {
            return this.$q.when(this.users); // Referencing below user array
        }
